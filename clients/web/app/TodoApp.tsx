...
export default function TodoApp() {
  ...
  const removeBackground = async () => {
    const base = process.env.NEXT_PUBLIC_API_URL || "";
    const response = await fetch(`${base}/api/media?kind=background`, { method: "DELETE", credentials: "include" });
